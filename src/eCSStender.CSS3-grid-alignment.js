	...
	e.register(
		...
		function( selector, properties, media, specificity )
		{
			...
			if ( prefixed_support )
			{
				switch ( TRUE )
				{
					case isSupported( PROPERTY, DISPLAY, MS + GRID ):
						prefix = MS;
						break;
					case isSupported( PROPERTY, DISPLAY, MOZ + GRID ):
						prefix = MOZ;
						break;
					case isSupported( PROPERTY, DISPLAY, OPERA + GRID ):
						prefix = OPERA;
						break;
					case isSupported( PROPERTY, DISPLAY, WEBKIT + GRID ):
						prefix = WEBKIT;
						break;
				}
