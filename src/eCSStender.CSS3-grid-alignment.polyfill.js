...
(function(e){
	...
	CSSGridAlignment.prototype.setup = function()
	{
		var
	...
	CSSGridAlignment.prototype.layout = function()
	{
	...
	CSSGridAlignment.prototype.getPosition = function( item )
	{
		var
		col	= item.column - 1,
		row	= item.row - 1,
	...
	CSSGridAlignment.prototype.getDimensions = function( item )
	{
		var
	 ...
	 **/
	CSSGridAlignment.prototype.determineGridAvailableSpace = function()
	{
		var
		gridElement			= this.gridElement,
	...
	CSSGridAlignment.prototype.determineSize = function ( dimension, margins, padding, borders )
	{
		var
	...
	CSSGridAlignment.prototype.verticalScrollbarWidth = function()
	{
		return ( self.innerWidth - DOCELMT.clientWidth );
	};
	CSSGridAlignment.prototype.horizontalScrollbarHeight = function()
	{
		return ( self.innerHeight - DOCELMT.clientHeight );
	};
	CSSGridAlignment.prototype.mapGridItemsToTracks = function ()
	{
		var
		items	= [],
	...
	CSSGridAlignment.prototype.gridAlignStringToEnum = function ( alignString )
	{
		switch ( alignString )
		{
	...
	CSSGridAlignment.prototype.positionStringToEnum = function ( positionString )
	{
	...
	CSSGridAlignment.prototype.blockProgressionStringToEnum = function (positionString)
	{
		switch ( positionString )
		{
			// default
	...
	CSSGridAlignment.prototype.gridTrackValueStringToEnum = function (trackValueString)
	{
	...
	CSSGridAlignment.prototype.ensureTracksExist = function ( trackManager, firstTrackNumber, lastTrackNumber )
	{
	...
	CSSGridAlignment.prototype.addItemToTracks = function (trackManager, itemToAdd, firstTrackNumber, lastTrackNumber)
	{
		var
		i					= 0,
	...
	CSSGridAlignment.prototype.saveItemPositioningTypes = function()
	{
	 ...
	 **/
	CSSGridAlignment.prototype.determineTrackSizes = function ( lengthPropertyName )
	{
		var
	...
	CSSGridAlignment.prototype.getActualTrackMeasure = function ( trackNumber, computingColumns )
	{
		var
	...
	CSSGridAlignment.prototype.compareAutoTracksAvailableGrowth = function ( a, b )
	{
		var
	...
	CSSGridAlignment.prototype.usePhysicalWidths = function ( blockProgression, verifyingColumns )
	{
	...
	CSSGridAlignment.prototype.trackIsFractionSized = function ( trackToCheck )
	{
		return ( trackToCheck.sizingType === sizingTypeEnum.valueAndUnit &&
				 trackToCheck.size.unit === "fr" );
	};
	CSSGridAlignment.prototype.getSumOfTrackMeasures = function ( trackManager )
	{
		var
	...
	CSSGridAlignment.prototype.getSumOfSpannedTrackMeasures = function ( trackManager, firstTrackNum, numSpanned )
	{
		var
		sum		= LayoutMeasure.zero(),
	...
	//CSSGridAlignment.prototype.adjustForTrackLengthDifferences = function ( tracks, computingColumns )
	//{
	//	var
	//	gridElement = this.gridElement,
	...
	//	return totalChange;
	//};
	CSSGridAlignment.prototype.getNormalFractionMeasure = function ( track )
	{
	...
	CSSGridAlignment.prototype.saveUsedCellWidths = function ( columnTrackManager )
	{
		var
	...
	CSSGridAlignment.prototype.calculateGridItemShrinkToFitSizes = function()
	{
		var
	...
	CSSGridAlignment.prototype.shouldSwapWidthAndHeight = function()
	{
		return ( this.blockProgression === blockProgressionEnum.lr ||
				 this.blockProgression === blockProgressionEnum.rl );
	};
	CSSGridAlignment.prototype.verifyGridItemSizes = function()
	{
		this.verifyGridItemLengths( TRUE );
		this.verifyGridItemLengths( FALSE );
	};
	CSSGridAlignment.prototype.verifyGridItemLengths = function ( verifyingColumnBreadths )
	{
		var
		items					= this.items,
		i						= items.length,
	...
	CSSGridAlignment.prototype.verifyGridItemPositions = function (gridObject)
	{
